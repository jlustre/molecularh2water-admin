...
@section('content')
    <div class="mx-auto max-w-3xl space-y-6">
        <section class="rounded-lg border border-teal-100 bg-white p-6 shadow-sm">
            ...
            <h1 class="mt-2 text-3xl font-black tracking-normal text-slate-950">Edit installer</h1>
            <p class="mt-2 text-sm leading-6 text-slate-500">
                Update contact details and active/archived status for {{ $installer->name }}.
            </p>
        </section>
        ...
        <section class="rounded-lg border border-teal-100 bg-white p-6 shadow-sm">
            <form method="POST" action="{{ route('admin.installers.update', $installer) }}">
                ...
                @include('admin.installers._form', [
                    ...
                    'cancelRoute' => route('admin.installers.show', $installer),
                ])
            </form>
        </section>
    </div>
