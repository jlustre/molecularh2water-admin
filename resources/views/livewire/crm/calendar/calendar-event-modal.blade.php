            ...
            <form class="space-y-4" wire:submit="save">
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select class="w-full rounded-xl border-slate-200" wire:model="calendar_event_type_id">
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-semibold text-slate-700">Starts</label>
                        <input class="w-full rounded-xl border-slate-200" type="datetime-local" wire:model="start_at" />
                    </div>
                    <div>
                        <label class="mb-1 block text-sm font-semibold text-slate-700">Ends</label>
                        <input class="w-full rounded-xl border-slate-200" type="datetime-local" wire:model="end_at" />
                    </div>
                    <div>
